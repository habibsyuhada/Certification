					...
					<div class="nav-container">
						<nav id="main-menu-navigation" class="navigation-main">
							...
							<!-- <div class="nav-item has-sub">
								<a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Registration</span></a>
								<div class="submenu-content">
									<a href="<?php echo base_url() ?>Registration" class="menu-item">Shipment List</a>
									<a href="<?php echo base_url() ?>Registration" class="menu-item">Create Shipment</a>
								</div>
							</div> -->
						</nav>
					</div>
